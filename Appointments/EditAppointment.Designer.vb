...
Partial Class EditAppointment
    ...
    Private Sub InitializeComponent()
        ...
        Label1.TabIndex = 0
        Label1.Text = "Editar Cita Médica"
        ...
        btnSave.Location = New Point(601, 482)
        ...
        ' btnRestore
        ' 
        btnRestore.Anchor = AnchorStyles.Bottom Or AnchorStyles.Right
        btnRestore.Location = New Point(514, 482)
        btnRestore.Margin = New Padding(6)
        ...
        ' GroupBox5
        ' 
        GroupBox5.Controls.Add(txtDiagnostic)
        GroupBox5.Location = New Point(21, 341)
        GroupBox5.Margin = New Padding(12)
        GroupBox5.Name = "GroupBox5"
        GroupBox5.Padding = New Padding(6, 3, 7, 3)
        GroupBox5.Size = New Size(305, 117)
        GroupBox5.TabIndex = 6
        GroupBox5.TabStop = False
        GroupBox5.Text = "Diagnóstico"
        ' 
        ' txtDiagnostic
        ' 
        txtDiagnostic.Dock = DockStyle.Fill
        txtDiagnostic.Location = New Point(6, 19)
        txtDiagnostic.Multiline = True
        txtDiagnostic.Name = "txtDiagnostic"
        txtDiagnostic.Size = New Size(292, 95)
        txtDiagnostic.TabIndex = 0
        ' 
        ' GroupBox6
        ' 
        GroupBox6.Controls.Add(txtPrescription)
        GroupBox6.Location = New Point(360, 341)
        GroupBox6.Margin = New Padding(12)
        GroupBox6.Name = "GroupBox6"
        GroupBox6.Padding = New Padding(6, 3, 7, 3)
        GroupBox6.Size = New Size(309, 117)
        GroupBox6.TabIndex = 7
        GroupBox6.TabStop = False
        GroupBox6.Text = "Prescripción"
        ' 
        ' txtPrescription
        ' 
        txtPrescription.Dock = DockStyle.Fill
        txtPrescription.Location = New Point(6, 19)
        txtPrescription.Multiline = True
        txtPrescription.Name = "txtPrescription"
        txtPrescription.Size = New Size(296, 95)
        txtPrescription.TabIndex = 0
        ' 
        ' EditAppointment
        ' 
    ...
    Friend WithEvents txtDiagnostic As TextBox
